...
Name: Gary Chung
Date: May 8, 2022
Description: A game in which a ball is thrown into a roulette wheel with the player being able to place bets on different numbers. Stats for the options are given
*/
...
public class Roulette extends Game {
    public Roulette(User[] players, double[] bets, int gameID) {
